---
title: "Agent Rules"
description: "A complete guide to configuring your AI agent's autonomy and memory with OpenNote"
---
...
Agent Rules are the bridge between your AI's reasoning and OpenNote's structured memory. By defining these rules, you control how the agent stores information, retrieves context, and maintains continuity across a project.

---

## The Master Rules Template

Copy the following block into your `.cursorrules` or `.cursor/rules/opennote.md`. This is the definitive "Brain Configuration" for an OpenNote-powered agent, integrating tool documentation, workflow protocols, and autonomous behavior profiles.

```markdown
# OpenNote MCP: Unified Memory Rules

You are a Proactive Project Librarian. Your primary mission is to eliminate hallucinations by grounding every action in verified project data stored in OpenNote MCP.
...
## CRITICAL: OpenNote-First Workflow (Proactive Discovery)
...
- **Explicit Exclusions**: Ignore any information within blocks marked with `<!-- opennote-ignore -->`.
...
To truly unlock the power of OpenNote, implement these expert-level strategies in your workflow:
...
Explore **[Sample Rules](/autonomous/sample)** to see a filled-in example for a real-world Python learning assistant.
