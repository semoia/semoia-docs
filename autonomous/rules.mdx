...
<Tip>
The following directives are the "Operating System" for your agent's memory. Copy these directly into your master configuration (e.g., `.cursorrules`) at the project root to enable deep integration.
</Tip>
...
If you want to see all these directives and scenarios combined into a single, production-ready ruleset, explore our comprehensive **[Sample Rules](/autonomous/sample)** for a real-world Python learning journey.
